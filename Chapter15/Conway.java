...
public class Conway {
    ...
    */
    ...
    /**
     * Ex 15.3 Creates a grid from plain text file. 
     */
    ...
    private void mainloop() {
        while (true) {
            //  display total alive cells in terminal
            //System.out.println("Cells Alive: " + grid.countOn());
            ...
            try {
                // time between each generation - changed from 500 to 200 for faster test.
                Thread.sleep(200);
    ...
    public static void main(String[] args) {
        ...
        Conway game = new Conway("gun.cells");
